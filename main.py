...
# =================================================================
# SECCIÓN 1: BRONZE (DATOS ORIGINALES)
# =================================================================
...
if df_bronze is not None:
    ...
    # --- TABLA DETALLADA BRONZE (Restaurada) ---
...
if df_silver is not None:
    ...
    with sc2:
        st.info("💡 **Observación de Ingeniería:** En esta etapa los duplicados son 0. El siguiente paso es la eliminación de columnas con >80% de nulos y la imputación de campos como 'Location Type'.")
else:
    st.warning("⚠️ Reporte Silver no encontrado en S3.")